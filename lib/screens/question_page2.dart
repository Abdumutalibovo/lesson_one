...
class _questionPage2State extends State<questionPage2> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            currentWidth: (MediaQuery.of(context).size.width * 0.78) *
                ((currentQuestonIndex + 1) / QuestionModel.questions2.length),
          ),
          SizedBox(height: 50,),
            ...
            children: [
              ...
              Padding(
                ...
                child: QuestionWidget(
                    QuestionTitle:
                        QuestionModel.questions2[currentQuestonIndex].question,
              ...
              AnswersWidget(
                questionModel: QuestionModel.questions2[currentQuestonIndex],
  ...
  nextQuestion() {
    setState(() {
      ...
      if (currentQuestonIndex != QuestionModel.questions2.length - 1) {
        start = 15;
        currentQuestonIndex++;
      }
      if (currentQuestonIndex == QuestionModel.questions2.length - 1) {
